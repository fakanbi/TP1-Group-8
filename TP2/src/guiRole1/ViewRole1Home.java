...
public class ViewRole1Home {
	...
	public static void displayRole1Home(Stage ps, User user) {
		...
		refreshPostList(PostManager.getInstance().getAllPosts());
	...
	private ViewRole1Home() {
		...
		button_CreatePost.setOnAction((event) -> {
		    ControllerRole1Home.performCreatePost(theStage, theUser);
		});
		...
		button_Search.setOnAction(e -> {
		    ...
		    ControllerRole1Home.performSearch(keyword);
		});

		button_ClearSearch.setOnAction(e -> {
		    text_SearchField.clear();
		    ControllerRole1Home.performSearch(""); // show all posts again
		});
		...
		button_DeletePost.setOnAction(e -> {
		    ControllerRole1Home.performDeletePost(theUser);
		});
		...
		button_EditPost.setOnAction(e -> {
		    ControllerRole1Home.performEditPost(theUser);
		});
		...
		button_Reply.setOnAction(e -> {
		    ControllerRole1Home.performReply(theUser);
		});
